...
class TestRtspMediaFactory(GstRtspServer.RTSPMediaFactory):
    ...
    t. ! queue ! wavescope ! videoconvert ! x264enc tune=zerolatency speed-preset=ultrafast profile=baseline ! video/x-h264,stream-format=byte-stream ! h264parse ! rtph264pay name=videopay
